...
private:
    ...
    // A1000: в 8.1 деструктор был не встроенным и давал символ
    // _ZN7android5FenceD1Ev, который нужен блобу hwcomposer.sc8830.so.
    // Из шима его не подменить — он приватный. Возвращаем тело в Fence.cpp.
    ~Fence();
