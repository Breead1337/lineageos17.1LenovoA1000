...
/* A1000: снимок экрана рисуется без перестановки каналов — она компенсирует
...
extern "C" void a1000_setSwizzleEnabled(bool enabled) { gA1000Swizzle = enabled; }
...
String8 ProgramCache::generateFragmentShader(const Key& needs) {
    ...
    // A1000 sc7731: компенсируем перестановку каналов DISPC/GSP/панели на Mali.
