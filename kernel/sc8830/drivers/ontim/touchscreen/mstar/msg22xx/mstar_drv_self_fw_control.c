...
static void _DrvFwCtrlMsg22xxGetTpVendorCode(u8 *pTpVendorCode)
{
    ...
    if (msg2xxx_info->ChipType == CHIP_TYPE_MSG22XX)
    {
...
static void _DrvFwCtrlMsg22xxProgramEmem(EmemType_e eEmemType) // For MSG22XX
{
    ...
    IicWriteData(msg2xxx_info->i2c_id_dbbus, &szDbBusTxData[0], 3);    

    szDbBusTxData[0] = 0x20;

    IicWriteData(msg2xxx_info->i2c_id_dbbus, &szDbBusTxData[0], 1);    
    ...
    while (nRemainSize > 0)
    {
        ...
        IicWriteData(msg2xxx_info->i2c_id_dbbus, &szDbBusTxData[0], nSize);
...
static s32 _DrvFwCtrlParsePacket(u8 *pPacket, u16 nLength, TouchInfo_t *pInfo)
{
    ...
    if (g_GestureWakeupFlag == 1)
    {
        ...
        if (msg2xxx_info->ChipType == CHIP_TYPE_MSG22XX && pPacket[0] == 0xA7 && pPacket[1] == 0x00 && pPacket[2] == 0x06 && pPacket[3] == 0x50)
        {
            nWakeupMode = pPacket[4];
            bIsCorrectFormat = 1;
        } 
        else if (msg2xxx_info->ChipType == CHIP_TYPE_MSG21XXA && pPacket[0] == 0x52 && pPacket[1] == 0xFF && pPacket[2] == 0xFF && pPacket[3] == 0xFF && pPacket[4] == 0xFF && pPacket[6] == 0xFF)
        {
        ...
        if (bIsCorrectFormat) 
        {
            ...
            switch (nWakeupMode)
            {
                case 0x58:
                    ...
                    printk("Light up screen by DOUBLE_CLICK gesture wakeup.\n");

                    input_report_key(msg2xxx_info->idev, KEY_POWER, 1);
                    input_sync(msg2xxx_info->idev);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 0);
                    input_sync(msg2xxx_info->idev);
                    break;        
                case 0x60:
...
//                    input_report_key(msg2xxx_info->idev, KEY_UP, 1);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 1);
                    input_sync(msg2xxx_info->idev);
//                    input_report_key(msg2xxx_info->idev, KEY_UP, 0);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 0);
                    input_sync(msg2xxx_info->idev);
                    break;        
                case 0x61:
...
//                    input_report_key(msg2xxx_info->idev, KEY_DOWN, 1);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 1);
                    input_sync(msg2xxx_info->idev);
//                    input_report_key(msg2xxx_info->idev, KEY_DOWN, 0);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 0);
                    input_sync(msg2xxx_info->idev);
                    break;        
                case 0x62:
...
//                  input_report_key(msg2xxx_info->idev, KEY_LEFT, 1);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 1);
                    input_sync(msg2xxx_info->idev);
//                    input_report_key(msg2xxx_info->idev, KEY_LEFT, 0);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 0);
                    input_sync(msg2xxx_info->idev);
                    break;        
                case 0x63:
...
//                    input_report_key(msg2xxx_info->idev, KEY_RIGHT, 1);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 1);
                    input_sync(msg2xxx_info->idev);
//                    input_report_key(msg2xxx_info->idev, KEY_RIGHT, 0);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 0);
                    input_sync(msg2xxx_info->idev);
                    break;        
                case 0x64:
...
//                    input_report_key(msg2xxx_info->idev, KEY_M, 1);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 1);
                    input_sync(msg2xxx_info->idev);
//                    input_report_key(msg2xxx_info->idev, KEY_M, 0);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 0);
                    input_sync(msg2xxx_info->idev);
                    break;        
                case 0x65:
...
//                    input_report_key(msg2xxx_info->idev, KEY_W, 1);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 1);
                    input_sync(msg2xxx_info->idev);
//                    input_report_key(msg2xxx_info->idev, KEY_W, 0);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 0);
                    input_sync(msg2xxx_info->idev);
                    break;        
                case 0x66:
...
//                    input_report_key(msg2xxx_info->idev, KEY_C, 1);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 1);
                    input_sync(msg2xxx_info->idev);
//                    input_report_key(msg2xxx_info->idev, KEY_C, 0);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 0);
                    input_sync(msg2xxx_info->idev);
                    break;
                case 0x67:
...
//                    input_report_key(msg2xxx_info->idev, KEY_E, 1);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 1);
                    input_sync(msg2xxx_info->idev);
//                    input_report_key(msg2xxx_info->idev, KEY_E, 0);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 0);
                    input_sync(msg2xxx_info->idev);
                    break;
                case 0x68:
...
//                    input_report_key(msg2xxx_info->idev, KEY_V, 1);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 1);
                    input_sync(msg2xxx_info->idev);
//                    input_report_key(msg2xxx_info->idev, KEY_V, 0);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 0);
                    input_sync(msg2xxx_info->idev);
                    break;
                case 0x69:
...
//                    input_report_key(msg2xxx_info->idev, KEY_O, 1);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 1);
                    input_sync(msg2xxx_info->idev);
//                    input_report_key(msg2xxx_info->idev, KEY_O, 0);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 0);
                    input_sync(msg2xxx_info->idev);
                    break;
                case 0x6A:
...
//                    input_report_key(msg2xxx_info->idev, KEY_S, 1);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 1);
                    input_sync(msg2xxx_info->idev);
//                    input_report_key(msg2xxx_info->idev, KEY_S, 0);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 0);
                    input_sync(msg2xxx_info->idev);
                    break;
                case 0x6B:
...
//                    input_report_key(msg2xxx_info->idev, KEY_Z, 1);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 1);
                    input_sync(msg2xxx_info->idev);
//                    input_report_key(msg2xxx_info->idev, KEY_Z, 0);
                    input_report_key(msg2xxx_info->idev, KEY_POWER, 0);
                    input_sync(msg2xxx_info->idev);
                    break;
                default:
        ...
        */
        if ((pPacket[1] == 0xFF) && (pPacket[2] == 0xFF) && (pPacket[3] == 0xFF) && (pPacket[4] == 0xFF) && (pPacket[6] == 0xFF))
        {
            ...
            {   /* 0x00 is key up, 0xff is touch screen up */
                ...
                if (msg2xxx_info->pdata->prox_enable && ((pPacket[5] == 0x80) || 
                        (pPacket[5] == 0x40)) && (msg2xxx_info->ps_input_dev))
                {
                    /*
                     * a1000: эхо команды включения, а не рука.
                     *
                     * Замер с пустым столом: на каждый взвод ровно два 0x40 —
                     * через ~5 мс и через ~1.9 с; 0x80 не приходит никогда, а
                     * настоящее приближение не даёт вообще ни одного пакета.
                     * Прошивка панели приближение не умеет (потому у вендора и
                     * включена симуляция). Сообщать по этим пакетам «близко»
                     * нельзя: система гасила бы экран в начале разговора и не
                     * включала обратно. Пакет глотаем, чтобы 0x40 не уехал в
                     * разбор клавиш, но в input ничего не отдаём.
                     */
                    return -1;
                }  
                ...
                if (pPacket[5] == 4) // TOUCH_KEY_HOME
                {
                    ...
                    {
                        pInfo->tPoint[0].nX = msg2xxx_info->panel_parm->virtual_key[1].logic_x ;
                        pInfo->tPoint[0].nY = msg2xxx_info->panel_parm->virtual_key[1].logic_y ;
                    }else
                    {
                ...
                else if (pPacket[5] == 1) // TOUCH_KEY_MENU
                {
                    if (msg2xxx_info->panel_parm->virtual_key)
                    {
                        pInfo->tPoint[0].nX = msg2xxx_info->panel_parm->virtual_key[0].logic_x ;
                        pInfo->tPoint[0].nY = msg2xxx_info->panel_parm->virtual_key[0].logic_y ;
                    }else
                    {
                ...
                else if (pPacket[5] == 2) // TOUCH_KEY_BACK
                {
                    if (msg2xxx_info->panel_parm->virtual_key)
                    {
                        pInfo->tPoint[0].nX = msg2xxx_info->panel_parm->virtual_key[2].logic_x ;
                        pInfo->tPoint[0].nY = msg2xxx_info->panel_parm->virtual_key[2].logic_y ;
                    }else
                    {
...
//            if ((nDeltaX == 0) && (nDeltaY == 0))
          if(
            ...
            {   /* one touch point */
                ...
                pInfo->tPoint[0].nX = (nX * msg2xxx_info->panel_parm->x_max_res) / TPD_WIDTH;
                pInfo->tPoint[0].nY = (nY * msg2xxx_info->panel_parm->y_max_res) / TPD_HEIGHT;
                DBG("[%s]: [x,y]=[%d,%d]\n", __func__, nX, nY);
            ...
            {   /* two touch points */
                ...
                pInfo->tPoint[1].nX = (nX2 * msg2xxx_info->panel_parm->x_max_res) / TPD_WIDTH; 
                pInfo->tPoint[1].nY = (nY2 * msg2xxx_info->panel_parm->y_max_res) / TPD_HEIGHT;
...
static s32 _DrvFwCtrlMsg21xxaUpdateFirmwareBySwId(u8 szFwData[][1024], EmemType_e eEmemType) // For MSG21XXA //showlo
{
        ...
        if (i < 32)   // emem_main
        {
            if (i == 31)
            {
                ...
                for (j = 0; j < 4; j ++)
                {
                    ...
                    printk("[kernel][%s %d]((nCrcTemp>>(8*%d)) & 0xFF)=%x\n",
                        __func__, __LINE__, j, ((nCrcTemp>>(8*j)) & 0xFF)); // add for debug
                    printk("[kernel][%s %d]Update main clock crc32 into bin buffer szFwData[%d][%d]=%x\n",
                        __func__, __LINE__, i, (1020+j), szFwData[i][1020+j]);
                }
            }
            else
            {
    ...
    if ((eEmemType == EMEM_ALL) || (eEmemType == EMEM_MAIN))
    {
        ...
        {
            printk("[kernel][%s %d]/-/-/-/-/-/Update FAILED/-/-/-/-/-/\n",__func__, __LINE__);
    ...
    printk("[kernel][%s %d]/-/-/-/-/-/Update SUCCESS/-/-/-/-/-/\n",__func__, __LINE__);
...
static void _DrvFwCtrlUpdateFirmwareBySwIdDoWork(struct work_struct *pWork)
{
    ...
    printk("[kernel][%s %d]/-/-/-/-/-/update firmware by sw id result = %d/-/-/-/-/-/\n",
        __func__, __LINE__, nRetVal);
    
    if (nRetVal == 0)
    {
        printk("[kernel][%s %d]update firmware by sw id success\n", __func__, __LINE__);
    ...
    else //nRetVal == -1
    {
        ...
        {
            printk("[kernel][%s %d ]update firmware by sw id failed\n", __func__, __LINE__);
...
static void _DrvFwCtrlReadInfoC33(void)
{
    ...
    szDbBusTxData[3] = 0x00;
    IicWriteData(msg2xxx_info->i2c_id_dbbus, szDbBusTxData, 4);    
    mdelay(100);
...
#if defined(CONFIG_I2C_SPRD) || defined(CONFIG_I2C_SPRD_V1)
    sprd_i2c_ctl_chg_clk(msg2xxx_info->i2c->adapter->nr, msg2xxx_info->i2c_update_clk);
    msleep(5);
#endif
    if (msg2xxx_info->ChipType == CHIP_TYPE_MSG21XXA) // (0x02)
    {
//        u16 nChipType;
        u8 nChipVersion = 0;
        ...
        ret = _DrvFwCtrlMsg21xxaUpdateFirmwareBySwId(szFwData, eEmemType);      
    }
    else if (msg2xxx_info->ChipType == CHIP_TYPE_MSG22XX) // (0x7A)
    {
        ret = _DrvFwCtrlMsg22xxUpdateFirmware(szFwData, eEmemType);
    }
...
u8 DrvFwCtrlGetChipType(void)
{
    ...
    msg2xxx_info->i2c_id_dbbus = SLAVE_I2C_ID_DBBUS_MSG22XX ;
    nChipType = _DrvGetChipType();

    if( !nChipType )
    {
        msg2xxx_info->i2c_id_dbbus = SLAVE_I2C_ID_DBBUS_MSG21XX ;
        nChipType = _DrvGetChipType();
    }

    printk("[kernel][%s+%d]/-/-/-/-/-/chip type 0x%x/-/-/-/-/-/\n",__func__,__LINE__,nChipType);
    return nChipType;
}

void DrvFwCtrlGetCustomerFirmwareVersion(u16 *pMajor, u16 *pMinor, u16 *pVendor)
{
    u16 eMainSwId = 0 ;
    u16 eInfoSwId = 0 ;
    ...
    DBG("*** %s() ***\n", __func__);    
    if (msg2xxx_info->ChipType == CHIP_TYPE_MSG21XXA || msg2xxx_info->ChipType == CHIP_TYPE_MSG21XX)
    {
        ...
        else if (msg2xxx_info->ChipType == CHIP_TYPE_MSG21XX)
        {
        ...
        *pMinor = (szDbBusRxData[3]<<8) + szDbBusRxData[2];
        ...
        eMainSwId = _DrvFwCtrlMsg21xxaGetSwId(EMEM_MAIN);
        eInfoSwId = _DrvFwCtrlMsg21xxaGetSwId(EMEM_INFO);
        msg2xxx_info->main_vendor = eMainSwId;
        msg2xxx_info->info_vendor = eInfoSwId;
        if (eMainSwId == eInfoSwId)
        {
            *pVendor = eMainSwId ;
        }
    ...
    else if (msg2xxx_info->ChipType == CHIP_TYPE_MSG22XX)
    {
        ...
        *pMinor = (((nRegData2 >> 8) & 0xFF) << 8) + (nRegData2 & 0xFF);
        ...
        eMainSwId = _DrvFwCtrlMsg22xxGetSwId(EMEM_MAIN);  
        eInfoSwId = _DrvFwCtrlMsg22xxGetSwId(EMEM_INFO);
    ...
    printk("[kernel][%s %d ]/-/-/-/-/-/get ic major = %d  minor = %d vendor = %d/-/-/-/-/-/\n", 
        __func__, __LINE__, *pMajor,*pMinor,*pVendor);
}
...
void DrvFwCtrlGetPlatformFirmwareVersion(u8 **ppVersion)
{
    ...
    if (msg2xxx_info->ChipType == CHIP_TYPE_MSG22XX) // Only MSG22XX support platform firmware version
    {
        // Stop mcu
        RegSetLByteValue(0x0FE6, 0x01); 
...
void DrvFwCtrlHandleFingerTouch(void)
{
    ...
    if (g_GestureWakeupFlag == 1)
    {
        ...
        pm_wakeup_event(&msg2xxx_info->i2c->dev, 3000);  //wanggang
        ...
        else if (msg2xxx_info->ChipType == CHIP_TYPE_MSG21XXA)
        {
            if (_gGestureWakeupPacket == NULL)
            {
    ...
    {
        if (0 == msg2xxx_info->suspend_state) 
        {
            //report...
            if ((tInfo.nFingerNum) == 0)   //touch end
            {
                if (nLastKeyCode != 0)
                {
                    ...
                    input_report_key(msg2xxx_info->idev, nLastKeyCode, 0);
            ...
            else //touch on screen
            {
                if (tInfo.nTouchKeyCode != 0)
                {
                    ...
                    {
                        if(msg2xxx_info->panel_parm->virtual_key[1].key_code)
                            nTouchKeyCode = msg2xxx_info->panel_parm->virtual_key[1].key_code;
                        else
                    ...
                    {
                        if(msg2xxx_info->panel_parm->virtual_key[0].key_code)
                            nTouchKeyCode = msg2xxx_info->panel_parm->virtual_key[0].key_code;
                        else
                    ...
                    {
                        if(msg2xxx_info->panel_parm->virtual_key[2].key_code)
                            nTouchKeyCode = msg2xxx_info->panel_parm->virtual_key[2].key_code;
                        else
                    ...
                    if (nLastKeyCode != nTouchKeyCode)
                    {
                        ...
                        input_report_key(msg2xxx_info->idev, nTouchKeyCode, 1);
                    }
#endif //CONFIG_TP_HAVE_KEY
                }
                else
...
s32 DrvFwCtrlCheckFirmwareUpdateBySwId(void)
{
    int i = 0 ;
    int retVal = 0;
    u16 nUpdateBinMajor = 0, nUpdateBinMinor = 0;
    ...
    msg2xxx_info->ChipType = DrvFwCtrlGetChipType() ;
    if( !msg2xxx_info->ChipType )
        return -1 ;
    
    DrvFwCtrlGetCustomerFirmwareVersion( &(msg2xxx_info->major_version), 
        &(msg2xxx_info->minor_version),&(msg2xxx_info->vendor_id));

    if( msg2xxx_info->major_version != msg2xxx_info->vendor_id )
    {
        printk("[kernel][%s %d]/-/[IC minor_version 0x%x != vender_id = 0x%x]/-/\n",
            __func__ ,__LINE__,msg2xxx_info->minor_version,msg2xxx_info->vendor_id) ;
        msg2xxx_info->major_version = msg2xxx_info->vendor_id;
    }
    for(i = 0; i < msg2xxx_info->pdata->panel_parm_num; i++)
    {
        if( (msg2xxx_info->major_version == msg2xxx_info->pdata->panel_parm[i].major_version ) \
            &&(msg2xxx_info->vendor_id == msg2xxx_info->pdata->panel_parm[i].vendor_id ) )
        {
            msg2xxx_info->panel_parm=&(msg2xxx_info->pdata->panel_parm[i]);
            msg2xxx_info->vendor_name=msg2xxx_info->pdata->panel_parm[i].vendor_name;

            msg2xxx_info->wakeup_enable = 0 ;
            msg2xxx_info->wakeup_event  = msg2xxx_info->panel_parm->wakeup_event;
            msg2xxx_info->wakeup_event_num = msg2xxx_info->panel_parm->wakeup_event_num;
            printk("[kernel][%s %d]/-/-/-/-/-/[minor 0x%x major = 0x%x]/-/-/-/-/-/\n",
                __func__ ,__LINE__,msg2xxx_info->minor_version,msg2xxx_info->major_version) ;
            
            break;
        }
    }
    if (i >= msg2xxx_info->pdata->panel_parm_num)
    {
        msg2xxx_info->panel_parm  = &(msg2xxx_info->pdata->panel_parm[0]);
        msg2xxx_info->vendor_name = msg2xxx_info->pdata->panel_parm[0].vendor_name;
        msg2xxx_info->wakeup_enable = 0 ;
        msg2xxx_info->wakeup_event  = msg2xxx_info->panel_parm->wakeup_event;
        msg2xxx_info->wakeup_event_num = msg2xxx_info->panel_parm->wakeup_event_num;
        msg2xxx_info->major_version  = msg2xxx_info->pdata->panel_parm[0].major_version ;
        printk("[kernel][%s %d]/-/-/-/-/-/use default soft parm 0 [major_version = 0x%x]/-/-/-/-/-/\n",
            __func__ ,__LINE__,msg2xxx_info->major_version) ;
        return retVal ;
    }

    if( msg2xxx_info->panel_parm->panel_fw == NULL )
        return retVal ;
    
    nMajor = msg2xxx_info->major_version ;
    nMinor = msg2xxx_info->minor_version ;
    if (msg2xxx_info->ChipType == CHIP_TYPE_MSG21XXA)   
    {
        nUpdateBinMajor = msg2xxx_info->panel_parm->panel_fw[0x7F4F]<<8 | msg2xxx_info->panel_parm->panel_fw[0x7F4E];
        nUpdateBinMinor = msg2xxx_info->panel_parm->panel_fw[0x7F51]<<8 | msg2xxx_info->panel_parm->panel_fw[0x7F50];

        if ( ( ((nUpdateBinMinor > nMinor) || (nMinor == 0x00) || (nMinor >= 50)) && 
                    (nUpdateBinMajor == nMajor) ) || (nMajor == 0 ) || (nMajor == 0xFF) )
        {
            for (i = 0; i < MSG21XXA_FIRMWARE_MAIN_BLOCK_SIZE; i ++)
            {
                _DrvFwCtrlStoreFirmwareData(&(msg2xxx_info->panel_parm->panel_fw[i*1024]), 1024);
            }
            
            retVal = DrvFwCtrlUpdateFirmware(g_FwData, EMEM_MAIN);
            msg2xxx_info->minor_version = nUpdateBinMinor ;
            printk("[kernel][%s %d]/-/-/-/-/-/msg21xxx updata ok/-/-/-/-/-/\n", __func__, __LINE__);
            printk("[kernel][%s %d]/-/-/-/-/-/[minor 0x%x major = 0x%x]/-/-/-/-/-/\n",
                __func__ ,__LINE__,msg2xxx_info->minor_version,msg2xxx_info->major_version) ;
        }
    }
    ...
    {
        nUpdateBinMajor = msg2xxx_info->panel_parm->panel_fw[0xBFF5]<<8 | msg2xxx_info->panel_parm->panel_fw[0xBFF4];
        nUpdateBinMinor = msg2xxx_info->panel_parm->panel_fw[0xBFF7]<<8 | msg2xxx_info->panel_parm->panel_fw[0xBFF6];
                    ...
                    (nUpdateBinMajor == nMajor) ) || (nMajor == 0 ) || (nMajor == 0xFF) )
        {
            for (i = 0; i < (MSG22XX_FIRMWARE_MAIN_BLOCK_SIZE+1); i ++)
            {
                ...
                {
                    _DrvFwCtrlStoreFirmwareData(&(msg2xxx_info->panel_parm->panel_fw[i*1024]), 512);
                }
            }
            
            retVal = DrvFwCtrlUpdateFirmware(g_FwData, EMEM_MAIN);
            msg2xxx_info->minor_version = nUpdateBinMinor ;
            printk("[kernel][%s %d]/-/-/-/-/-/msg22xxx updata ok/-/-/-/-/-/\n", __func__, __LINE__);
            printk("[kernel][%s %d]/-/-/-/-/-/[minor 0x%x major = 0x%x]/-/-/-/-/-/\n",
                __func__ ,__LINE__,msg2xxx_info->minor_version,msg2xxx_info->major_version) ;
        }
    }
...
s32  DrvFwCtrlFwForceUpdate(void)
{
    int i = 0 ;
    int retVal = 0 ;
    u16 nUpdateBinMajor = 0, nUpdateBinMinor = 0;
    ...
    if(file == NULL)
    {
        file = filp_open("/sdcard/msg22xx.bin", O_RDONLY, 0);
        if (IS_ERR(file))
        {
            printk("[kernel]**** Not find update file use default !****\n");
            return -1;
        }
        else
        {
            loff_t *pos = &(file->f_pos);
            printk("******open file = %x is ok******\n",file);
            old_fs = get_fs();
            set_fs(KERNEL_DS);

            file_len = file->f_dentry->d_inode->i_size;
            buf = (char *)kmalloc(49*1024,GFP_KERNEL);
            if( buf == NULL )
            {
                printk("******kmalloc buf failed******\n");
                return -1 ;
            }
            if( vfs_read(file, buf, file_len, pos) <= 0 )
            {
        ...
        nMajor = msg2xxx_info->major_version ;
        nMinor = msg2xxx_info->minor_version ;
        nUpdateBinMajor = buf[0xBFF5]<<8 | buf[0xBFF4];
        nUpdateBinMinor = buf[0xBFF7]<<8 | buf[0xBFF6];

        if ( nMajor != nUpdateBinMajor || nMinor != nUpdateBinMinor ) 
        {
            printk("******copy file to g_FwData length %d buf 0x%x******\n",file_len,buf[0x7f51]);
            for (i = 0; i < (MSG22XX_FIRMWARE_MAIN_BLOCK_SIZE+1); i ++)
            {
                if (i < MSG22XX_FIRMWARE_MAIN_BLOCK_SIZE) // i < 48
                {
                    _DrvFwCtrlStoreFirmwareData(&buf[i*1024], 1024);
                }
                else // i == 48
                {
                    _DrvFwCtrlStoreFirmwareData(&buf[i*1024], 512);
                }
            }
            retVal = DrvFwCtrlUpdateFirmware(g_FwData, EMEM_ALL);
            msg2xxx_info->minor_version = nUpdateBinMinor ;
            msg2xxx_info->major_version = nUpdateBinMajor ;
            printk("[kernel]****update ok [minor 0x%x major = 0x%x]****\n",
                  msg2xxx_info->minor_version,msg2xxx_info->major_version) ;
        }else
            printk("****nUpdateBinMajor=nMajor is 0x%x not update*****\n",nMajor);
...
s32 DrvFwCtrlEnableProximity(void)
{
    ...
    if (msg2xxx_info->ChipType == CHIP_TYPE_MSG21XX)
    {
        szDbBusTxData[2] = 0x62; 
    }
    else if (msg2xxx_info->ChipType == CHIP_TYPE_MSG21XXA || msg2xxx_info->ChipType == CHIP_TYPE_MSG22XX)
    {
        szDbBusTxData[2] = 0x4a; 
    }
    else
    {
        printk("[kernel]*** Un-recognized chip type = 0x%x ***\n", msg2xxx_info->ChipType);
        return -1;
    }
    ...
    if (rc > 0)
    {
        printk("[kernel][%s]***Enable proximity detection success\n",__func__);
    }
    else
    {
        printk("[kernel][%s]***Enable proximity detection failed\n",__func__);
    }
    return rc;
}
