...
#############################################################################
# A1000_SLIM: CJK убран и из SMALLER_FONT_FOOTPRINT-сборок (18 МБ на .ttc).
# Emoji остаются — они по-прежнему только под MINIMAL_FONT_FOOTPRINT.
ifeq (,$(filter true,$(MINIMAL_FONT_FOOTPRINT) $(SMALLER_FONT_FOOTPRINT)))
