...
public class PrintSettingPreferenceController extends BasePreferenceController implements
    ...
    @Override
    public void onStart() {
        // A1000: печать вырезана из сборки, PrintManager == null, а Lifecycle
        // зовёт onStart и у недоступных контроллеров.
        if (mPrintManager != null) mPrintManager.addPrintJobStateChangeListener(this);
    }

    @Override
    public void onStop() {
        if (mPrintManager != null) mPrintManager.removePrintJobStateChangeListener(this);
    }
    ...
    public CharSequence getSummary() {
        if (mPrintManager == null) return null;
