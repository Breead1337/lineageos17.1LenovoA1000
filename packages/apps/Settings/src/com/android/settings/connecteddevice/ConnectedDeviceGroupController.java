...
public class ConnectedDeviceGroupController extends BasePreferenceController
    ...
    @Override
    public void onStart() {
        if (mBluetoothDeviceUpdater != null) mBluetoothDeviceUpdater.registerCallback();
    ...
    @Override
    public void onStop() {
        if (mConnectedUsbDeviceUpdater != null) mConnectedUsbDeviceUpdater.unregisterCallback();
    ...
    public void init(DashboardFragment fragment) {
        ...
        // A1000: Bluetooth — свой раздел: там только BT, в «Подключённых» — USB и док.
